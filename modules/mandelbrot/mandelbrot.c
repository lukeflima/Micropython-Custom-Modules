...
STATIC void madelbrot_readfrom(
                                int width,
                                int height, 
                                float real_start, 
                                float real_end, 
...
STATIC mp_obj_t mandelbrot(size_t n_args, const mp_obj_t *args) 
{
    ...
    madelbrot_readfrom(width, height, real_start, real_end, imaginary_start, imaginary_end, iterations, colour_base[0], buffer);
...
STATIC mp_obj_t mandelbrot_into(size_t n_args, const mp_obj_t *args) 
{
    ...
    madelbrot_readfrom(width, height, real_start, real_end, imaginary_start, imaginary_end, iterations, colour_base[0], bufinfo.buf);
